...
ruta_dir_scripts = rf'C:\Users\{usuario_red}\Documents\git_hub\Claro-Prioritarias\02. Reversion Movil\02. Depure Proceso'

scripts = [
    "sql_ejec_sps_depurador_general.py",
    "clean_data_depurador_general_RECUPERA.py"
        ]
