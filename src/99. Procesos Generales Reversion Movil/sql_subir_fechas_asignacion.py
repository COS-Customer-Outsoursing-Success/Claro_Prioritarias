...
nombre_de_tabla = 'tb_fechas_asignacion'

# -----------> Cargar el archivo Excel
archivo_excel = r'Z:\WORKFORCE\03. Mission\Emerson Aguilar\01.Claro\02.Claro Prioritarias\03.Tercer_Anillo_Reversion\Asignaciones_Rever_Mov.xlsx'
