...
class load_asignacion():
    ...
    def __init__(self):
        ...
        self.table = 'tb_asignacion_fincomercio_v2'

        self.current_folder = os.path.dirname(os.path.abspath(__file__))
        self.project_root = os.path.dirname(self.current_folder)
        self.project_root = os.path.dirname(self.current_folder)
        self.start_path =  os.path.join(self.project_root, 'data', 'asignacion','nueva','asignacion_fincomercio')
    ...
    def read_data(self):
        ...
        try:
            ...
            self.df = reader.read_directory(latest_file_path, sheet_name='Estructura Base')
            ...
            columnas_necesarias = [
                ...
                'cedula', 'genero', 'nombre_y_apellido', 'fechanacimiento', 'placa',
                'codmunicipio', 'nommunicipio', 'coddpto', 'nomdepto', 'direccion',
                'telefono1', 'telefono2', 'telefono3', 'telefono_4',
                'fecha_fin_vigencia_actual_', 'modelo', 'linea', 'motor', 'chasis',
                'cod_fasecolda', 'marca', 'marca_y_linea', 'tasa', 'suma_asegurada',
                'aseguradora_actual', 'clase_vehiculo', 'servicio', 'email',
                'no_temporario_plus_plus', 'prima_plus_plus', 'prima_sin_iva_plus_plus',
                'no_temporario_plus_vip', 'prima_plus_vip', 'prima_sin_iva_plus_vip',
                'no_temporario_moto_plus', 'prima_moto_plus', 'prima_sin_iva_moto_plus',
                'no_temporario_moto_esencial', 'prima_moto_esencial',
                'prima_sin_iva_moto_esencial', 'perfil', 'perfil_2', 'observaciones_1',
                'observaciones_2', 'fecha_asignacion', 'anio', 'periodo',
                'nombre_base'
