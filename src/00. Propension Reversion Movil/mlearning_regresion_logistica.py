...
print(cadena_de_conexion)  # --------> Solo para verificar
...
def variables_objeto(variable_objeto):
    ...
    for var in variable_objeto:
        ...
        region,
        edad,
        valor_cargas AS vlrcargas,
        valor_minimo_cargas AS vlrmincargas,
        valor_total_datos AS vlrtdatos,
        valor_total_voz AS vlrtvoz,
        {var}
        FROM bbdd_cos_bog_claro_reversion_movil.tb_dts_final
        ...
        # --------> Asegurar que las filas de X y y coincidan
