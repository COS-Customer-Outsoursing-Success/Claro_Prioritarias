...
nom_informe = 'Cos Conection'
campana = 'Recuperacion'
asunto = 'PRUEBAS ENVIO NUEVO'
buen_dia = 'Buen Día,'
cuerpo_correo = f'Se realiza envió de informe {nom_informe} correspondiente a la campaña de {campana} actualizado a corte del {ayer_form}. Se adjunta detalle para su validación'
texto_adicional = 'Quedo atento a cualquier tipo de novedad que se tenga en relacion a lo enviado'

# ------------> Rutas Compartida
archivo_adjunto = rf'Z:\WORKFORCE\03. Mission\Emerson Aguilar\04. Novedades de Conexión\01.Claro_Prioritarias\{nom_mes_formateado_ruta_2}\{ayer_dia}\Claro - Prioritarias_Recuperacion.xlsx'
